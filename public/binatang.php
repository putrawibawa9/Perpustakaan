        ...
        <div id="carouselExample" class="carousel slide carousel-fade h-100">
            <div class="carousel-inner h-100">
                <div class="carousel-item h-100 active">
                    <img src="../img/book2.jpg" class="d-block w-100 h-70 object-fit-cover" alt="Gambar 1">
                </div>
                <div class="carousel-item h-100">
                    <img src="../img/book1.jpg" class="d-block w-100 h-100 object-fit-cover" alt="Gambar 2">
                </div>
                <div class="carousel-item h-100">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3 class="text-center mt-2" id="modal-nama"></h3>
                <div class="text-center mt-2"> Buku <span id="modal-kategori" ></span></div>
