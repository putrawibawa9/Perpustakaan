        ...
        <div id="carouselExample" class="carousel slide carousel-fade h-100">
            ...
            <div class="row">
                <div class="col-12 p-5">
                    <h1 class="display-4"> Rita Krisna Dewi</h1>
                
                    <p align="justify">Ni Putu Rita Krisna Dewi (220030707), adalah nama lengkap saya, ini adalah tugas Akhir berupa Web yang saya buat</p>
                    <br>
