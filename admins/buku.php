              ...
              <?php foreach($binatang as $row):?>
                <tr>
                  ...
                  <td class="text-center" > <img src="../img/<?=$row['gambar']?>" width="100px"></td>
                   <td>
                    <a  href="buku-form.php?id_binatang=<?=$row['id_binatang'];?>" class="btn btn-warning btn-sm ">Edit</a>
                    <a href="binatang-delete.php?id_binatang=<?=$row['id_binatang'];?>" class="btn btn-danger btn-sm " onclick="return confirm('yakin?');">Hapus</a>
                   </td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
